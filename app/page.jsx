  ...
  return <main className="site-frame">
    <section className="hero" id="home">
      ...
      <header className="header shell">
        ...
        <a className="outline-btn" href="#contacts">Оставить заявку <ArrowUpRight /></a>
      </header>
    ...
    <section className="how" id="how">
      ...
      <div className="how__content shell">
        ...
        <div className="how__panel">
          <p className="eyebrow">КАК ВСЕ РАБОТАЕТ?</p>
      ...
      <div className="footer-zone shell" id="contacts">
        ...
        <div className="footer-zone__right"><a className="pink-btn pink-btn--small" href="mailto:hello@cosmo.agency">Стать частью Cosmo <ArrowUpRight /></a><button className="moon" aria-label="Theme">◐</button></div>
      </div>
    </section>
  </main>;
}
