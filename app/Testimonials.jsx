...
const labels = {
  ru: { eyebrow: 'ОТЗЫВ СОТРУДНИЦЫ', person: 'COSMO GIRL', meta: 'РЕАЛЬНАЯ ИСТОРИЯ', cta: 'Пройти регистрацию', next: 'Твоя история может быть следующей' },
  ua: { eyebrow: 'ВІДГУК ДІВЧИНИ', person: 'COSMO GIRL', meta: 'РЕАЛЬНА ІСТОРІЯ', cta: 'Пройти реєстрацію', next: 'Твоя історія може бути наступною' },
  en: { eyebrow: 'TEAM MEMBER REVIEW', person: 'COSMO GIRL', meta: 'REAL STORY', cta: 'Complete registration', next: 'Your story can be next' },
};

function localizedText(review, locale, index) {
  ...
  if (locale === 'en') return [
    ...
    'I just want to say THANK YOU ❤️ I have never had this kind of support from an admin before. The work itself is such a vibe: you communicate, earn, and the payments are always on time 😂 I have already saved money for a new laptop and camera.',
  ...
  return [
    SOURCE_REVIEWS[0].text,
    SOURCE_REVIEWS[1].text,
    SOURCE_REVIEWS[2].text,
