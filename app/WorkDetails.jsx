const content = {
  ru: {
    ...
    intro: 'Всё важное до регистрации: график, выплаты, формат работы, обучение, поддержка и правила общения.',
    ...
    cards: [
      ...
      {n:'03',title:'Доход',lines:['Новые COSMO Girls в первый месяц — от 35 000 грн.','Опытные COSMO Girls — от 110 000 грн.','Итог зависит от количества платных минут, активности пользователей, донатов и виртуальных подарков.']},
      ...
      {n:'07',title:'Переезд в Одессу',featured:true,lines:['Если для работы нужен переезд в Одессу — COSMO может помочь с организацией.','При необходимости мы арендуем квартиру, чтобы у тебя было комфортное место для старта.','Если нет подходящей техники, команда также может предоставить необходимое оборудование для работы.']},
    ]
  },
  ua: {
    eyebrow: 'УМОВИ РОБОТИ',
    title: 'ЯК ВЛАШТОВАНА РОБОТА В COSMO',
    intro: 'Усе важливе до реєстрації: графік, виплати, формат роботи, навчання, підтримка та правила спілкування.',
    ...
    cards: [
      ...
      {n:'03',title:'Дохід',lines:['Нові COSMO Girls у перший місяць — від 35 000 грн.','Досвідчені COSMO Girls — від 110 000 грн.','Підсумок залежить від кількості платних хвилин, активності користувачів, донатів і віртуальних подарунків.']},
      ...
      {n:'07',title:'Переїзд до Одеси',featured:true,lines:['Якщо для роботи потрібен переїзд до Одеси — COSMO може допомогти з організацією.','За потреби ми орендуємо квартиру, щоб у тебе було комфортне місце для старту.','Якщо немає відповідної техніки, команда також може надати необхідне обладнання для роботи.']},
    ]
  },
  en: {
    eyebrow: 'WORK CONDITIONS',
    title: 'HOW WORK AT COSMO IS STRUCTURED',
    intro: 'Everything important before registration: schedule, payouts, work format, training, support and communication rules.',
    ...
    cards: [
      ...
      {n:'03',title:'Income',lines:['New COSMO Girls in their first month — from UAH 35,000.','Experienced COSMO Girls — from UAH 110,000.','Final income depends on paid chat minutes, user activity, tips and virtual gifts.']},
      ...
      {n:'07',title:'Relocation to Odesa',featured:true,lines:['If you need to relocate to Odesa for work, COSMO can help organize the move.','When needed, we can rent an apartment so you have a comfortable place to get started.','If you do not have suitable equipment, the team can also provide the necessary work setup.']},
    ]
  }
};
  ...
  return <section className="work-details" id="work-details">
    <div className="shell work-details__inner">
      ...
      <div className="work-details__grid">
        {t.cards.map(card=><article className={`work-detail-card${card.featured?' work-detail-card--featured':''}`} key={card.n}>
